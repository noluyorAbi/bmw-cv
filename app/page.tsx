  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white dark:bg-black">
      <BackgroundLines className="flex w-full flex-col items-center justify-center px-4">
        ...
        <p className="mx-auto mt-3 max-w-xs text-center text-sm font-semibold text-gray-600 dark:text-gray-400 sm:max-w-sm md:text-lg font-helvetia select-none ">
          Erfahren Sie, wie ich IT-Kommunikation verständlich und zugänglich
          mache.
        </p>
        <Link href="/about-me">
          <button className="text-md mt-5   transform rounded-lg bg-gradient-to-r from-[#0079EA] via-[#522DAB] to-[#F60502] px-3 py-2 font-helvetia select-none text-white dark:text-white shadow-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl sm:mt-8 sm:px-5 md:text-lg">
