...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100 bg-dot-thick-purple-800 dark:bg-dot-thick-[#0079EA]"
        style={{
